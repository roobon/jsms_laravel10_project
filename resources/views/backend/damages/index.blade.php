    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg bg-green">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                ...
                <h5 class="txt-light">All Damage Items those reported to Company</h5>
            </div>
            <!-- Breadcrumb -->
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                    <li class="active"><span>Damages</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right"><a href="{{ route('damage.create') }}" class="btn btn-success">New Damage
                                Entry</a>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 15%;" class="text-center">
                                                        <form onSubmit="return confirm('Are you sure to Delete')"
                                                            action="{{ route('sales.destroy', $item->id) }}" method="post">
                                                            <a class="btn btn-default btn-icon-anim btn-circle"
                                                                href="{{ route('sales.show', $item->id) }}"><i
