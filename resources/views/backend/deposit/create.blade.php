                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form class="form-horizontal" method="post" action="{{ route('deposit.store') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="exampleInputuname_4"
                                                    class="col-sm-3 control-label">Check/Voucher Number*</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputuname_4" class="col-sm-3 control-label">Deposit
                                                    Amount*</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="deposit_amount"
                                                            value="{{ old('deposit_amount') }}" class="form-control"
                                                            id="exampleInputuname_4" placeholder="Enter Deposit Amount">
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="date" name="deposit_date"
                                                            value="{{ old('deposit_date') }}" class="form-control"
