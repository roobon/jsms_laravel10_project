							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="row">
										<div class="col-md-5">
											<div class="item-big">
												<img class="img-responsive" id="item-display" src="{{$employee->photo ? asset($employee->photo):asset('images/nophoto.jpg')}}" alt="product"/>
											</div>
										</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="panel panel-default card-view">
							...
							<div  class="panel-wrapper collapse in">
								...
								<div class="panel-footer txt-dark font-12"> Panel Footer </div>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="panel panel-default card-view">
							<div  class="panel-wrapper collapse in">
								<div  class="panel-body">
									<h6 class="mb-15">body title heading h6</h6>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est vitae ultrices accumsan. Aliquam ornare lacus adipiscing, posuere lectus et, fringilla augue.</p>
									<button class="btn  btn-primary mt-20">button</button>
								</div>
							</div>
						</div>
					</div>
