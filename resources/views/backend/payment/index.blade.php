...
@section('title')
    Payment/Deposit to Company List
@endsection
    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg bg-green">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                ...
                <h5 class="txt-light">Paid/Deposit to Company List</h5>
            </div>
            <!-- Breadcrumb -->
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right"><a href="{{ route('payment.create') }}" class="btn btn-success">New
                                Payment</a></div>
                                                    ...
                                                    <td style="width: 15%;" class="text-center">
                                                        <form onSubmit="return confirm('Are you sure to Delete')"
                                                            ...
                                                            <a class="btn btn-default btn-icon-anim btn-circle"
                                                                href="{{ route('payment.show', $item->id) }}"><i
