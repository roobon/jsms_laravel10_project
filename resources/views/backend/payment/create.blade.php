                                    ...
                                    <div class="form-wrap">
                                        <form class="form-horizontal" method="post" action="{{ route('payment.store') }}"
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputuname_4" class="col-sm-3 control-label">Payment
                                                    Method*</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputuname_4"
                                                    class="col-sm-3 control-label">Vourcher/Cheque*</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="voucher" value="{{ old('voucher') }}"
                                                            class="form-control" id="exampleInputuname_4"
                                                            placeholder="Enter Voucher or cheque Number">
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="payment_amount"
                                                            ...
                                                            id="exampleInputuname_4" placeholder="Enter Payment Amount">
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputuname_4" class="col-sm-3 control-label">Payment to
                                                    Company*</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputuname_4" class="col-sm-3 control-label">Payment from
                                                    Business*</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <textarea type="text" name="payment_note" class="form-control" id="exampleInputEmail_4"
                                                            placeholder="Enter any message" rows="10">{{ old('payment_note') }}</textarea>
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                            </div>
