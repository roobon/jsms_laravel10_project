                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-wrap">
                                        <form class="form-horizontal" method="post"
                                            action="{{ route('points.update', $point->id) }}" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="point_name"
                                                            value="{{ $point->point_name ?? old('point_name') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <textarea type="text" name="point_address" class="form-control" id="exampleInputEmail_4"
                                                            placeholder="Enter Center Address" rows="10">{{ $point->point_address ?? old('point_address') }}</textarea>
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputuname_4" class="col-sm-3 control-label">Opening
                                                    Date*</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="date" name="opening_date"
                                                            value="{{ $point->opening_date ?? old('opening_date') }}"
                                                            class="form-control" id="exampleInputuname_4">
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <img src="{{ $point->photo ? asset($point->photo) : 'images/nophoto.jpg' }}"
                                                        alt="" width="300">
                                                </div>
                                            </div>
