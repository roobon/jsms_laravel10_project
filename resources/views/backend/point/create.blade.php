												...
												<div class="form-wrap">
													<form class="form-horizontal" method="post" action="{{route('points.store')}}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="text" name="point_name" value="{{old('point_name')}}" class="form-control" id="exampleInputuname_4" placeholder="Enter Center Name">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="input-group">
																	<textarea type="text" name="point_address" class="form-control" id="exampleInputEmail_4" placeholder="Enter Address" rows="10">{{old('point_address')}}</textarea>
																	<div class="input-group-addon"></div>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															<label for="exampleInputuname_4" class="col-sm-3 control-label">Launching Date*</label>
															<div class="col-sm-9">
																<div class="input-group">
																	<input type="date" name="opening_date" value="{{old('opening_date')}}" class="form-control" id="exampleInputuname_4">
																	<div class="input-group-addon"></div>
																</div>
															</div>
														</div>
