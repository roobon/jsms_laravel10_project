        ...
        <div class="row heading-bg bg-green">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Edit Stock</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Edit Stock Details</h6>
                        </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="date" name="last_business"
                                                            value="{{ $retailer->last_business_date ?? old('last_business') }}"
                                                            class="form-control" id="exampleInputuname_4">
                                                        <div class="input-group-addon"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="last_balance"
                                                            value="{{ $retailer->last_balance ?? old('last_balance') }}"
                                                            class="form-control" id="exampleInputuname_4"
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <select name="status" id="" class="form-control">
                                                            ...
                                                            <option value="active"
                                                                {{ $retailer->status == 'active' ? 'selected=selected' : '' }}>
                                                                Active</option>
                                                            <option value="inactive"
                                                                {{ $retailer->status == 'inactive' ? 'selected=selected' : '' }}>
                                                                Inactive</option>
                                                        </select>
                                                        <div class="input-group-addon"></div>
                                                    </div>
