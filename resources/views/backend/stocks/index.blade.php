            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right"><a href="{{ route('stock.create') }}" class="btn btn-success">New Stock</a>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 15%;" class="text-center">
                                                        <form onSubmit="return confirm('Are you sure to Delete')"
                                                            action="{{ route('stock.destroy', $item->id) }}" method="post">
                                                            <a class="btn btn-default btn-icon-anim btn-circle"
                                                                href="{{ route('stock.show', $item->id) }}"><i
