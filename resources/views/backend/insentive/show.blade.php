                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="item-big">
                                        <img class="img-responsive" id="item-display"
                                            src="{{ $investment->investment_photo ? asset($investment->investment_photo) : asset('images/nophoto.jpg') }}"
                                            alt="product" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-7">
                                    <div class="product-detail-wrap">
                                        ...
                                        <div class="product-price head-font mb-30">Address:
                                            {{ $investment->investment_address }}
                                        </div>

                                        <h4 class="mb-20">Business Info</h4>
                                        <p class="mb-50">investment Establishment Date: {{ $investment->opening_date }}
                                            <br>
                                        </p>
                                        ...
                                        <div class="btn-group mr-10">
                                            <a href="{{ route('investment.index') }}" class="btn btn-success btn-anim"><i
                                                    class="fa  fa-angle-double-left"></i><span class="btn-text">Back to
                                                    investments list</span></a>
                                        </div>
